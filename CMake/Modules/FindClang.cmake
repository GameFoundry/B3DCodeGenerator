...
FIND_AND_ADD_CLANG_LIB(LLVMWindowsManifest)
FIND_AND_ADD_CLANG_LIB(LLVMXRay)
FIND_AND_ADD_CLANG_LIB(LLVMLibDriver)
FIND_AND_ADD_CLANG_LIB(LLVMDlltoolDriver)
FIND_AND_ADD_CLANG_LIB(LLVMTelemetry)
FIND_AND_ADD_CLANG_LIB(LLVMTextAPIBinaryReader)
...
FIND_AND_ADD_CLANG_LIB(LLVMX86TargetMCA)
...
FIND_AND_ADD_CLANG_LIB(LLVMWebAssemblyDisassembler)
FIND_AND_ADD_CLANG_LIB(LLVMWebAssemblyAsmParser)
FIND_AND_ADD_CLANG_LIB(LLVMWebAssemblyCodeGen)
FIND_AND_ADD_CLANG_LIB(LLVMWebAssemblyUtils)
FIND_AND_ADD_CLANG_LIB(LLVMWebAssemblyDesc)
FIND_AND_ADD_CLANG_LIB(LLVMWebAssemblyInfo)
FIND_AND_ADD_CLANG_LIB(LLVMVEDisassembler)
FIND_AND_ADD_CLANG_LIB(LLVMVEAsmParser)
FIND_AND_ADD_CLANG_LIB(LLVMVECodeGen)
FIND_AND_ADD_CLANG_LIB(LLVMVEDesc)
FIND_AND_ADD_CLANG_LIB(LLVMVEInfo)
...
FIND_AND_ADD_CLANG_LIB(LLVMSPIRVCodeGen)
FIND_AND_ADD_CLANG_LIB(LLVMSPIRVDesc)
FIND_AND_ADD_CLANG_LIB(LLVMSPIRVInfo)
FIND_AND_ADD_CLANG_LIB(LLVMSPIRVAnalysis)
...
FIND_AND_ADD_CLANG_LIB(LLVMRISCVTargetMCA)
FIND_AND_ADD_CLANG_LIB(LLVMRISCVDisassembler)
FIND_AND_ADD_CLANG_LIB(LLVMRISCVAsmParser)
FIND_AND_ADD_CLANG_LIB(LLVMRISCVCodeGen)
FIND_AND_ADD_CLANG_LIB(LLVMRISCVDesc)
FIND_AND_ADD_CLANG_LIB(LLVMRISCVInfo)
...
FIND_AND_ADD_CLANG_LIB(LLVMMSP430Disassembler)
FIND_AND_ADD_CLANG_LIB(LLVMMSP430AsmParser)
...
FIND_AND_ADD_CLANG_LIB(LLVMLoongArchDisassembler)
FIND_AND_ADD_CLANG_LIB(LLVMLoongArchAsmParser)
FIND_AND_ADD_CLANG_LIB(LLVMLoongArchCodeGen)
FIND_AND_ADD_CLANG_LIB(LLVMLoongArchDesc)
FIND_AND_ADD_CLANG_LIB(LLVMLoongArchInfo)
...
FIND_AND_ADD_CLANG_LIB(LLVMBPFAsmParser)
FIND_AND_ADD_CLANG_LIB(LLVMBPFCodeGen)
FIND_AND_ADD_CLANG_LIB(LLVMBPFDesc)
FIND_AND_ADD_CLANG_LIB(LLVMBPFInfo)
FIND_AND_ADD_CLANG_LIB(LLVMAVRDisassembler)
FIND_AND_ADD_CLANG_LIB(LLVMAVRAsmParser)
FIND_AND_ADD_CLANG_LIB(LLVMAVRCodeGen)
FIND_AND_ADD_CLANG_LIB(LLVMAVRDesc)
FIND_AND_ADD_CLANG_LIB(LLVMAVRInfo)
...
FIND_AND_ADD_CLANG_LIB(LLVMARMUtils)
FIND_AND_ADD_CLANG_LIB(LLVMARMInfo)
FIND_AND_ADD_CLANG_LIB(LLVMAMDGPUTargetMCA)
...
FIND_AND_ADD_CLANG_LIB(LLVMOrcDebugging)
FIND_AND_ADD_CLANG_LIB(LLVMOrcJIT)
FIND_AND_ADD_CLANG_LIB(LLVMWindowsDriver)
FIND_AND_ADD_CLANG_LIB(LLVMMCJIT)
FIND_AND_ADD_CLANG_LIB(LLVMJITLink)
FIND_AND_ADD_CLANG_LIB(LLVMInterpreter)
FIND_AND_ADD_CLANG_LIB(LLVMExecutionEngine)
FIND_AND_ADD_CLANG_LIB(LLVMRuntimeDyld)
FIND_AND_ADD_CLANG_LIB(LLVMOrcTargetProcess)
FIND_AND_ADD_CLANG_LIB(LLVMOrcShared)
FIND_AND_ADD_CLANG_LIB(LLVMDWP)
FIND_AND_ADD_CLANG_LIB(LLVMDebugInfoLogicalView)
FIND_AND_ADD_CLANG_LIB(LLVMDebugInfoGSYM)
FIND_AND_ADD_CLANG_LIB(LLVMOption)
FIND_AND_ADD_CLANG_LIB(LLVMObjectYAML)
FIND_AND_ADD_CLANG_LIB(LLVMObjCopy)
FIND_AND_ADD_CLANG_LIB(LLVMMCA)
FIND_AND_ADD_CLANG_LIB(LLVMMCDisassembler)
FIND_AND_ADD_CLANG_LIB(LLVMLTO)
FIND_AND_ADD_CLANG_LIB(LLVMPasses)
FIND_AND_ADD_CLANG_LIB(LLVMHipStdPar)
FIND_AND_ADD_CLANG_LIB(LLVMCFGuard)
FIND_AND_ADD_CLANG_LIB(LLVMCoroutines)
FIND_AND_ADD_CLANG_LIB(LLVMipo)
FIND_AND_ADD_CLANG_LIB(LLVMVectorize)
FIND_AND_ADD_CLANG_LIB(LLVMSandboxIR)
FIND_AND_ADD_CLANG_LIB(LLVMLinker)
FIND_AND_ADD_CLANG_LIB(LLVMInstrumentation)
FIND_AND_ADD_CLANG_LIB(LLVMFrontendOpenMP)
FIND_AND_ADD_CLANG_LIB(LLVMFrontendOffloading)
FIND_AND_ADD_CLANG_LIB(LLVMFrontendOpenACC)
FIND_AND_ADD_CLANG_LIB(LLVMFrontendHLSL)
FIND_AND_ADD_CLANG_LIB(LLVMFrontendDriver)
FIND_AND_ADD_CLANG_LIB(LLVMFrontendAtomic)
FIND_AND_ADD_CLANG_LIB(LLVMExtensions)
FIND_AND_ADD_CLANG_LIB(LLVMDWARFLinkerParallel)
FIND_AND_ADD_CLANG_LIB(LLVMDWARFLinkerClassic)
FIND_AND_ADD_CLANG_LIB(LLVMDWARFLinker)
...
FIND_AND_ADD_CLANG_LIB(LLVMCodeGenTypes)
FIND_AND_ADD_CLANG_LIB(LLVMCGData)
FIND_AND_ADD_CLANG_LIB(LLVMIRPrinter)
FIND_AND_ADD_CLANG_LIB(LLVMInterfaceStub)
FIND_AND_ADD_CLANG_LIB(LLVMFileCheck)
FIND_AND_ADD_CLANG_LIB(LLVMFuzzMutate)
FIND_AND_ADD_CLANG_LIB(LLVMScalarOpts)
FIND_AND_ADD_CLANG_LIB(LLVMInstCombine)
FIND_AND_ADD_CLANG_LIB(LLVMAggressiveInstCombine)
...
FIND_AND_ADD_CLANG_LIB(LLVMDebugInfoBTF)
...
FIND_AND_ADD_CLANG_LIB(LLVMTextAPI)
...
FIND_AND_ADD_CLANG_LIB(LLVMFuzzerCLI)
FIND_AND_ADD_CLANG_LIB(LLVMCore)
FIND_AND_ADD_CLANG_LIB(LLVMRemarks)
FIND_AND_ADD_CLANG_LIB(LLVMBitstreamReader)
FIND_AND_ADD_CLANG_LIB(LLVMBinaryFormat)
FIND_AND_ADD_CLANG_LIB(LLVMTargetParser)
